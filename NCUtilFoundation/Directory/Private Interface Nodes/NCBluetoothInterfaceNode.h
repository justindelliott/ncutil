...
/*!
  @class NCBluetoothInterfaceNode
  A subclass of <TT>NCInterfaceNode</TT> that represents a bluetooth modem
  device.  This is an extremely limited private subclass, and represents
  the minimal amount of work necessary!
*/
@interface NCBluetoothInterfaceNode : NCInterfaceNode
...
@implementation NCBluetoothInterfaceNode

  - (NCPropertyHandler*) propertyHandler
  {
    static NCPropertyHandler* NCBluetoothInterfaceNodePropertyHandler = nil;
    if (NCBluetoothInterfaceNodePropertyHandler == nil) {
      CFIndex         count = 16;
      ...
      NCBluetoothInterfaceNodePropertyHandler = [[NCPropertyHandler propertyHandlerWithProperties:properties count:count] retain];
    ...
    return NCBluetoothInterfaceNodePropertyHandler;
  }
